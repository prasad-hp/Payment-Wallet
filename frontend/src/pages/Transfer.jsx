...
function TransferPage(){
    ...
    const page =<div className="max-h-screen h-screen bg-gray-200">
                    ...
                    <div className="bg-gray-200 flex justify-center md:pt-16 ">
                        <div className="bg-white w-full pt-5 px-2 flex flex-col items-center pb-5 rounded-xl md:w-1/3 max-w-lg min-w-md h-full py-5">
                            ...
                            <form onSubmit={transferFunds} className="w-full flex flex-col items-center">
                                ...
                                <div className="w-full flex align-middle justify-center">   
                                    <button className="border-2 w-10/12 rounded-md h-12 bg-green-600 text-white text-3 py-2 md:my-5" type="submit">Initiate Tranfer</button>
                                </div>
                            </form>
                        </div>
                    </div>
